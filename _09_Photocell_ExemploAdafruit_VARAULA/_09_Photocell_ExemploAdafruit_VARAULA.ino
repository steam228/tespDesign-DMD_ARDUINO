//Variação Aula para apresentar AnalogWrite
...
int ledPin2 = 11; //porta segundo LEd para comparação

int intensidadeLed = 0; // variavel nova
...
void loop(void) {
  ...
  intensidadeLed = map(photocellReading,0,1000,0,255);

  analogWrite(ledPin2,intensidadeLed);
